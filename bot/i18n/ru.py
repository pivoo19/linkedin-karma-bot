...
translations = {
    ...
    "weekly": "за неделю",
    "total": "всего",
    "supported_all_time": "🎖️{count} - поддержал других за всё время, из них {first_day} — в первый день",
    "of_which_first_day": "из них в первый день: {count}",
...
/set_lang <ru|en> - Установить язык группы
/set_period <дни> - Установить период подсчёта кармы
/set_veteran <число> - Установить порог для статуса ветерана
